                  ...
                  child: Column(
                    ...
                    children:  [
                      ...
                      defaultTextInput(
                          ...
                          onChange: (String val)=> onEmailFieldSubmitted(val,"Changed"),
                          onFieldSubmit: (String val)=> onEmailFieldSubmitted(val,"Submitted"),
                          validationCallBack: (value)=>validateEmptyStr(value)
                      ),
                      ...
                      defaultTextInput(
                          ...
                          onChange: (String val)=> onPassFieldSubmitted(val,"Changed"),
                          onFieldSubmit: (String val)=> onPassFieldSubmitted(val,"Submitted"),
                          validationCallBack: (value)=>validateEmptyStr(value),
                          suffixPressed: ()=>{
                          setState(()=>{
                                frmCRT.displayPassField = !frmCRT.displayPassField
                          })
                      }
                      ),
                      const SizedBox(height: 20,),
  ...
  static onPassFieldSubmitted(inputVal,action){
   ...
   submitForm(){
    ...
    if(validate!=null && validate) {
      if (kDebugMode) {
        print("Form Submitted :" + frmCRT.emailCtr.text + "&&" +
