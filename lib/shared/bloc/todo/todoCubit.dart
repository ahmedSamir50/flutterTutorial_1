...
import 'package:my_flutter_tutorial_learn1/modules/todoapp/archived.dart';
import 'package:my_flutter_tutorial_learn1/modules/todoapp/done.dart';
import 'package:my_flutter_tutorial_learn1/modules/todoapp/tasks.dart';
...
import 'package:my_flutter_tutorial_learn1/shared/netwok/local/sqlitedb/todo/db_handeler.dart';
...
class TODOAppCubit extends Cubit<TODOStateBase> {
  ...
  void insertNewTask() {
    appIsLoading();
    dbHandler.InsertNewTask(
            todoFormController.newTaskTitleController.text,
            todoFormController.newTaskDateController.text,
            todoFormController.newTaskTimeController.text)
        .then((value) {
  ...
  void setTaskAsDoneOrAnyOtherState(int id,
      {TODOAPPTASKStatuses taskNewState = TODOAPPTASKStatuses.DONE}) {
